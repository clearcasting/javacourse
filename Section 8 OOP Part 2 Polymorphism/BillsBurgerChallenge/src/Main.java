...
//        defaultMeal.printOrder();
        ...
        MealOrder fullMeal = new MealOrder(new Side("soup"), new Drink("lemonade", "medium"), new Burger("cheeseburger"));
//        fullMeal.addToppings();
//        fullMeal.printOrder();


        //meal with a deluxe burger, all items, drink, side item, toppings up to 5, included in burger price
        MealOrder deluxeMeal = new MealOrder(new Side("fries"), new Drink("coke", "large"), new Burger("deluxe"));
