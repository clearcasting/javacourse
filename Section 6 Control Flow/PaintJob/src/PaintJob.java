...
//        → should return -1 since the width parameter is invalid
        ...
        System.out.println(getBucketCount(3.4, 2.1, 1.5, 2));
//        → should return 3 since the wall area is 7.14, a single bucket can cover an area of 1.5 and Bob has 2 extra buckets home.

        System.out.println(getBucketCount(2.75, 3.25, 2.5, 1));
//        → should return 3 since the wall area is 8.9375, a single bucket can cover an area of 2.5 and Bob has 1 extra bucket at home.
...
//        → should return 5 since the wall area is 3.26, and a single bucket can cover an area of 0.75 .
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        if (area % bucketsNeeded != 0) {
            bucketsNeeded = Math.ceil(bucketsNeeded);
        }

        return (int) Math.round(bucketsNeeded - extraBuckets);
    }
